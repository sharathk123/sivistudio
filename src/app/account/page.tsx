        ...
        <main className="bg-bone min-h-screen flex flex-col">
            <div className="flex-grow flex items-center justify-center pt-32 pb-20 px-6">
                <div className="text-center max-w-2xl mx-auto">
                    <span className="text-sage text-xs uppercase tracking-[0.3em] font-bold">Member Access</span>
                    ...
                    <p className="text-charcoal-400 text-lg leading-relaxed">
                        Manage your orders and preferences. This feature is currently under development.
                    </p>
                </div>
            </div>
            <Footer />
